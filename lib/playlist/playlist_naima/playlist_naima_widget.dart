...
import 'playlist_naima_model.dart';
export 'playlist_naima_model.dart';

class PlaylistNaimaWidget extends StatefulWidget {
  const PlaylistNaimaWidget({super.key});

  @override
  State<PlaylistNaimaWidget> createState() => _PlaylistNaimaWidgetState();
}

class _PlaylistNaimaWidgetState extends State<PlaylistNaimaWidget>
    with TickerProviderStateMixin {
  late PlaylistNaimaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlaylistNaimaModel());
